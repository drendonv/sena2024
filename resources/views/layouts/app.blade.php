...
<head>
    ...
    <title>@yield("titulo", "Laly Taller Creativo")</title>
...
<body>
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="bg-green-100 my-4 text-center">
            <h1 class="text-lg font-semibold m-4 uppercase">
                @yield('cabecera', 'Bienvenido a Laly Taller Creativo')
            </h1>
        </div>
        <div class="content">
            @yield('contenido')
    ...
    <footer class="footer footer-center p-10 bg-base-200 text-base-content rounded">
        <nav class="grid grid-flow-col gap-4">
            <a class="link link-hover" href="{{ route('about') }}">Acerca de nosotros</a>
            <a class="link link-hover" href="{{ route('contacto') }}">Contacto</a>
        ...
        <aside>
            <p>SENA2024 Copyright © 2024 - All right reserved by ACME Industries Ltd</p>
        </aside>
    </footer>
</body>
</html>
